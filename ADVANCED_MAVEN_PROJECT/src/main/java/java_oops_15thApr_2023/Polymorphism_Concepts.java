...
public class Polymorphism_Concepts {
	...
	//3. IS-A Relationship
	//4. Access modifier of child class overriding method should have higher or equivalent
	//   access compared to Parent class method
	
	//public > default > protected > private
	
	//Parent method is public then the child has to be public
	//Parent method is protected then the child can also have both protected and public
