...
public class Strings_Revision {
	...
	//String is Class
			//String Object can be directly created
			//String Constant(Literal) Pool
			//String, StringBuffer , StringBuilder
			//Immutability Concept of String Classes
	...
	public static void main(String[] args) {
		...
		String S = new String("Selenium");//2 objects will be created - 1 in HM, 1 in SLP/SCP memory
