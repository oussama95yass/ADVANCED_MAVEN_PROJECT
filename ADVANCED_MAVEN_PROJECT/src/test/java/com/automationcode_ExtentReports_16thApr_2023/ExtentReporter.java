...
public class ExtentReporter {
	...
	//Step3 : Create the object of File Class and pass the path of the .html file in the constructor
	...
	sparkReporter.config().setDocumentTitle("TNReportTitle|Automation|Resulsts");
	sparkReporter.config().setTimeStampFormat("MM/dd/yyyy hh:mm:ss");
	
	
	//Step6: We need to attach the ExtentReport with the SparkRepporter 
	extentReport.attachReporter(sparkReporter);
	
	//Step7 : Additional information
	//Step .1 : Create a Properties file and add necessary details in the Properties file
	//Step .2 : You have to write the Code of how to read data from the Properties file here
